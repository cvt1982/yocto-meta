...
DEPENDS = "kbd kbd-consolefonts kbd-keymaps glibc-locale glibc-utils localedef"
...
do_install() {
    ...
    install -d ${D}${sysconfdir}/keymap/consolefonts
    install -m 0755 ${WORKDIR}/consolefonts/* ${D}${sysconfdir}/keymap/consolefonts
